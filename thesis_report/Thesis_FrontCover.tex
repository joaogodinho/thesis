...
\vspace{1.0cm}
{\FontLb Malware Detection via Machine Learning} \\ % <<<<< EDIT TITLE
%\vspace{0.2cm}
%{\FontMn Subtitle (optional)} \\
%\vspace{1.9cm}
\vspace{2.6cm}
{\FontMb João Carlos Fernandez Godinho} \\ % <<<<< EDIT NAME
\vspace{2.0cm}
{\FontSn \coverThesis} \\
\vspace{0.3cm}
...
\end{tabular} } \\
\vspace{1.5cm}
{\FontMb May 2018} \\ % <<<<< EDIT DATE (corresponds to date of oral examination)
%
\end{center}
