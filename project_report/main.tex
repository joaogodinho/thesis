...
\say{Artificial Intelligence: A Modern Approach 3rd Edition}.
Prentice Hall, 2010

\bibitem{rossow:practices}
Rossow C., Dietrich C., Grier C., Kreibich C., Paxson V., Pohlmann N., Bos H. and Steen M.:
\say{Prudent Pratices for Designing Malware Experiments: Status Quo and Outlook} in IEEE Symposium on Security and Privacy, 2012

\bibitem{miller:rev_int}
Miller, B., Kantchelian, A., Tschantz, M., Afroz S., Bachwani R., Faizullabhoy R., Huang L., Shankar V., Wu T., Yiu G., Joseph A. and Tygar J.:
\say{Reviewer Integration and Performance Measurement for Malware Detection} in DIMVA, 2016
